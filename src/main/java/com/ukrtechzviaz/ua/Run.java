...
public class Run {
    public static void main(String[] args) throws BrokenQueuePassportBuilderException, NoSuchGazoprovidNameException {
        ...
        passportBuilder.addPassport(dovidnuk.getNazvuKompanii("компанія"),dovidnuk.getNazvuFilii("філія"),"перший",dovidnuk.getGazoprovidName("газопровід"),5,"Київ");
        passportBuilder.addZagalniDani(TupRemonty.Kapitalnui,"Київ",new Date(),"організація","організація","землекористувач");
        passportBuilder.addTehnHarKatod(new Date(),"перетворювач","виробник",new Date(),12313,TupZahusnogoPokruttia.ZaliznuiBlockBox,5,6,true,"спосіб",true,"тип",5,4,"примітка");
        passportBuilder.addAnodneZazemlennia(new Date(),"простий","виробник","проста",5,5,5,5,5,5,5,"організація","примітки");
